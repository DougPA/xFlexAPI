...
public final class Radio : NSObject, TcpManagerDelegate, UdpManagerDelegate {
    ...
    ///
    fileprivate func parseMessage(_ commandSuffix: String) {
    ...
    /// - parameter commandSuffix: a Command Suffix
    ///
    fileprivate func parseReply(_ commandSuffix: String) {
    ...
    /// - parameter commandSuffix: a Command Suffix
    ///
    fileprivate func parseStatus(_ commandSuffix: String) {
    ...
    ///
    fileprivate func parseAudioStream(_ keyValues: KeyValuesArray, notInUse: Bool) {
    ...
    ///   - keyValues:      a KeyValuesArray
    ///
    fileprivate func parseAtu(_ keyValues: KeyValuesArray) {
    ...
    ///   - notInUse:       true = "in_use=0", otherwise false
    ///
    fileprivate func parseDisplay(_ keyValues: KeyValuesArray, notInUse: Bool) {
        // ***** Panadapter Formats *****
        //
    ...
    ///   - keyValues:      a KeyValuesArray
    ///
    fileprivate func parseEqualizer(_ keyValues: KeyValuesArray) {
    ...
    ///   - keyValues:      a KeyValuesArray
    ///
    fileprivate func parseGps(_ keyValues: KeyValuesArray) {
    ...
    ///   - keyValues:      a KeyValuesArray
    ///
    fileprivate func parseInterlock(_ keyValues: KeyValuesArray) {
    ...
    ///   - notInUse:       true = "in_use=0", otherwise false
    ///
    fileprivate func parseMeter(_ keyValues: KeyValuesArray, notInUse: Bool) {
    ...
    ///   - notInUse:       true = "in_use=0", otherwise false
    ///
    fileprivate func parseMicAudioStream(_ keyValues: KeyValuesArray, notInUse: Bool) {
    ...
    ///   - keyValues:      a KeyValuesArray
    ///
    fileprivate func parseOpus(_ keyValues: KeyValuesArray) {
    ...
    ///   - keyValues:      a KeyValuesArray
    ///
    fileprivate func parseStream(_ keyValues: KeyValuesArray) {
    ...
    ///   - notInUse:       true = "in_use=0", otherwise false
    ///
    fileprivate func parseTXAudioStream(_ keyValues: KeyValuesArray, notInUse: Bool) {
    ...
    ///   - keyValues:      a KeyValuesArray
    ///
    fileprivate func parseXvtr(_ keyValues: KeyValuesArray, notInUse: Bool) {
...
//            let width = CGFloat(s.filterHigh) - CGFloat(s.filterLow)
    ...
    ///   - keyValues:          a KeyValuesArray
    ///
    fileprivate func parseInfoReply(_ keyValues: KeyValuesArray) {
    ...
    ///   - reply:          the reply
    ///
    fileprivate func parseMeterListReply(_ reply: String) {
    ...
    ///   - keyValues:          a KeyValuesArray
    ///
    fileprivate func parseVersionReply(_ keyValues: KeyValuesArray) {
    ...
    ///
    fileprivate func setupCommands(_ commands: [Commands]) -> [(CommandTuple)] {
...
//                    array.append( (command.rawValue + "\(_udp.port)", false, nil) )
    ...
    ///
    fileprivate func sendCommands(_ commands: [CommandTuple]) {
    ...
    ///
    fileprivate func appFolder() -> URL {
    ...
    ///
    fileprivate func checkFirmwareVersion(_ selectedRadio: RadioParameters) {
    ...
    ///
    fileprivate func loadFilters(filterPath userFilePath: String) -> [FilterMode:[FilterSpec]] {
    ...
    ///
    fileprivate func keyValuesArray(_ keyValueString: String?, delimiter: String = " ") -> KeyValuesArray {
    ...
    ///
    @objc fileprivate func tcpPingStarted(_ note: Notification) {
    ...
    /// - Parameter note:   a Notification instance
    ///
    @objc fileprivate func tcpPingTimeout(_ note: Notification) {
